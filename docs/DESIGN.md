...
> Design notes for **legaltech-faq-suggestions** — a runnable typescript example that Typed legal-tech FAQ suggestions from matter text.
...
- **Feature code** — the actual task: faq suggestions.
...
- `vector.query` — mapped to `POST /v1/vector/query`.
